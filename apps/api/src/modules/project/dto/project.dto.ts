...
export interface ProjectSummaryDto { readonly id: string; readonly name: string; readonly description: string | null; readonly environmentCount: number; readonly createdAt: string; readonly updatedAt: string; }
